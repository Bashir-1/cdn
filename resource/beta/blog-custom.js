/**
 * @fileoverview  自定义脚本，由 imsyy 创作，NCC-17039修改
 * @version 1.0.4
 * @description 提供额外的样式和视觉增强效果
 *
 * @license MIT
 *
 *
...
const observeElementChanges = (selector, callbacks, isStop = true) => {
  ...
  const customFooter = (el) => {
    try {
      if (el !== null) {
        el.innerHTML = `<div class="custom-footer"><p><a href="//www.ncc17039.eu.org" target= "_blank">主站</a> | <a href="/@login" target= "_blank">登录 </a> | <a href="/@manage" target= "_blank">后台 </a> | <a href="mailto:Maxwell448844@outlook.com" target= "_blank">联系 </a> | <a href="https://cdn.ncc17039.eu.org/data/" target= "_blank">政策 </a></p><p>由谷歌云提供服务 | 由NOS对象存储提供支持</a></p></div>`;
      }
    } catch (error) {
