...
const customFooter = (el) => {
  try {
    if (el !== null) {
      el.innerHTML = `<p> <a href="/@login" target= "_blank">登录 </a> | <a href="/@manage" target= "_blank">后台 </a> | <a href="mailto:master@starshine.love" target= "_blank">联系 </a> | <a href="https://starshine.love" target= "_blank">主页</a> | <a href="http://talk.ncc17039.eu.org/" target= "_blank">论坛</a> </p> <p> <!--<span>本站已稳定运行 <span id="sitetime" style="color: #0196e3;"></span>---> <iframe src="https://uptime.starshine.love/badge?theme=light" width="250" height="30" frameborder="0" scrolling="no"></iframe></p> </p> <p><b>版权所有 © 2021-2023 NCC-17039</b></p></div>`;
    }
  } catch (error) {
...
const customLogo = (el) => {
  try {
    if (el !== null) {
      ...
      // 设置新元素的内容
      const newLogo = `<a href="/" class="left-all"><span class="name">星辰存储库</span></a>`;
      // 使用innerHTML设置新元素的内容
